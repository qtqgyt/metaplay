 ...
 *
 */
package net.qwertygaming.metaplay;

import org.apache.logging.log4j.Logger;
import org.apache.logging.log4j.LogManager;

import net.qwertygaming.metaplay.init.MetaplayModPotions;
import net.qwertygaming.metaplay.init.MetaplayModMobEffects;
...
@Mod("metaplay")
public class MetaplayMod {
	public static final Logger LOGGER = LogManager.getLogger(MetaplayMod.class);
	public static final String MODID = "metaplay";
	...
	public MetaplayMod() {
		...
		MetaplayModItems.REGISTRY.register(bus);
		MetaplayModEntities.REGISTRY.register(bus);
		MetaplayModBlockEntities.REGISTRY.register(bus);
