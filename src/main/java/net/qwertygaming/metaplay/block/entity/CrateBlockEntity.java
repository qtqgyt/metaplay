...
public class CrateBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public CrateBlockEntity(BlockPos position, BlockState state) {
		super(MetaplayModBlockEntities.CRATE.get(), position, state);
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new CrateInventoryMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
