...
import net.qwertygaming.metaplay.procedures.GrinderGUIWhileThisGUIIsOpenTickProcedure;
...
public class GrinderGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public GrinderGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MetaplayModMenus.GRINDER_GUI.get(), id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 43, 36) {
		}));
		this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 104, 36) {
			@Override
