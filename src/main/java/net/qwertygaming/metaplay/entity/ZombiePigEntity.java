...
public class ZombiePigEntity extends Monster {
	public ZombiePigEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MetaplayModEntities.ZOMBIE_PIG.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(MetaplayModEntities.ZOMBIE_PIG.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
				(entityType, world, reason, pos, random) -> (world.getDifficulty() != Difficulty.PEACEFUL && Monster.isDarkEnoughToSpawn(world, pos, random) && Mob.checkMobSpawnRules(entityType, world, reason, pos, random)));
		DungeonHooks.addDungeonMob(MetaplayModEntities.ZOMBIE_PIG.get(), 180);
	}
